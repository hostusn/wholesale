 ...
 * @see   WP_Widget
 */
class Helendo_Price_Filter_List_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'classname'   => 'widget_text helendo-price-filter-list',
			'description' => esc_html__( 'Shows a price filter list in a widget which lets you narrow down the list of shown products when viewing product categories.', 'helendo' ),
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'helendo-price-filter-list', esc_html__( 'Helendo Price Filter List', 'helendo' ), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Content:', 'helendo' ); ?></label>
        ...
        <p><?php esc_html_e( 'Enter the price by format: min_price|max_price. Divide price list with linebreaks (Enter). Example:', 'helendo' ); ?></p>
        <p><?php esc_html_e( '100|200', 'helendo' ); ?><br><?php esc_html_e( '200|300', 'helendo' ); ?>
            <br><?php esc_html_e( '300|400', 'helendo' ); ?></p>
		<?php
	}
}
