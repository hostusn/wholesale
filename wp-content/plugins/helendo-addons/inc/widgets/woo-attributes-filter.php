 ...
 * @extends  WC_Widget
 */
class Helendo_Widget_Attributes_Filter extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce helendo_attributes_filter widget_layered_nav';
		$this->widget_description = esc_html__( 'Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.', 'helendo' );
		$this->widget_id          = 'helendo_attributes_filter';
		$this->widget_name        = esc_html__( 'Helendo Attributes Filter', 'helendo' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			'title'      => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Filter by', 'helendo' ),
				'label' => esc_html__( 'Title', 'helendo' )
			),
			'attribute'  => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'helendo' ),
				'options' => $attribute_array
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'helendo' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'helendo' ),
					'or'  => esc_html__( 'OR', 'helendo' )
				)
			),
			'height' => array(
				'type'  => 'text',
	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type, $height ) {
		...
		foreach ( $terms as $term ) {
			...
			echo apply_filters( 'helendo_color_filter_nav_count', '<span class="count">' . absint( $count ) . '</span>', $count, $term );
