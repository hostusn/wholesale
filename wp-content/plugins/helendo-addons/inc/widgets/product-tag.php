 ...
 *
 */
class Helendo_Widget_Product_Tag_Cloud extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_cssclass    = 'woocommerce widget_product_tag_cloud helendo_widget_product_tag_cloud';
		$this->widget_description = esc_html__( 'Your most used product tags in cloud format.', 'helendo' );
		$this->widget_id          = 'helendo_product_tag_cloud';
		$this->widget_name        = esc_html__( 'Helendo Product Tags', 'helendo' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Product Tags', 'helendo' ),
