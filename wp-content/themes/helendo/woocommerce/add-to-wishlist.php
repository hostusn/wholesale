...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr( $product_id ) ?>">
	<?php if ( ! ( $disable_wishlist && ! is_user_logged_in() ) ): ?>
		...
		?>
        <div class="yith-wcwl-add-button <?php echo esc_attr( $add_class ); ?>"
             style="display:<?php echo esc_attr( $add_style ); ?>">
        ...
        <div class="yith-wcwl-wishlistexistsbrowse <?php echo esc_attr( $browse_class ); ?>"
             style="display:<?php echo esc_attr( $browse_style ); ?>">
	...
	<?php else: ?>
		...
		), get_permalink( wc_get_page_id( 'myaccount' ) ) ) ) ?>" title="<?php echo esc_attr( $label ); ?>"
           data-rel="tooltip" class="<?php echo str_replace( 'add_to_wishlist', '', $link_classes ) ?>">
			<?php echo esc_html( $browse_wishlist_text ); ?>
        </a>
	<?php endif; ?>
