<?php
class Helendo_Mega_Menu {
	/**
	 * Helendo_Mega_Menu constructor.
	 */
	...
	public function edit_nav_menu_walker() {
		return 'Helendo_Mega_Menu_Walker_Edit';
	}
}
...
add_action( 'init', function() {
	...
	$mrbara_mega_menu = new Helendo_Mega_Menu();
} );